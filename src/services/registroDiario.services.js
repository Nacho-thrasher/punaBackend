...
// const getRegistrosByCompanyDayMonth = async(company, day, month )=>{}
const getRegistrosByCompanyAndDate = async(company, date)=>{
    try {
        const registrosDiarios = await RegistroDiario.aggregate([
            {
                $unwind: {
...
module.exports = { getRegistrosByCompanyAndDateNoAdmin ,getRegistrosByDateNoAdmin, getAllRegistroDiarioNoAdmin, getRegistrosByDate, createRegistroDiario, getAllRegistrosDiarios, getRegistrosByCompanyAndDate, getAllRegistrosDiariosToday };